      ...
      {isOpen && (
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-1">
            <div>
              <h2 className="text-lg font-bold text-gray-900">Modifiers (Options Manager)</h2>
        ...
        <div className="flex-1 flex overflow-hidden min-h-0">
          ...
          <div className="w-80 border-r border-gray-100 flex flex-col shrink-0 bg-gray-50/20">
            <div className="p-4 border-b border-gray-100 flex justify-between items-center shrink-0">
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Options list</span>
              <button 
                  ...
                  <div
                    ...
                    className={`w-full p-3.5 rounded-2xl flex items-center justify-between cursor-pointer transition-all border ${
                      activeCategoryId === cat.id
                        ? 'bg-orange-50/50 border-orange-300 text-gray-900 font-bold'
            ...
            <div className="p-3 border-t border-gray-100 bg-white shrink-0">
              <button
                onClick={() => void handleAddCategory()}
                className="w-full py-3 rounded-xl border border-dashed border-gray-300 hover:border-corgi text-gray-400 hover:text-corgi flex items-center justify-center gap-1.5 text-xs font-bold cursor-pointer transition-all active:scale-[0.98]"
              >
            ...
            {activeCategory ? (
              <>
                ...
                <div className="flex justify-between items-start">
                    ...
                    {editingField === 'name' ? (
                      <div className="flex gap-2 items-center h-9">
                        <input
                          ...
                          className="h-9 w-56 bg-white border border-gray-200 focus:border-corgi focus:ring-4 focus:ring-corgi/10 rounded-xl px-3.5 text-sm font-bold text-gray-950 outline-none transition-all"
                          autoFocus
                          onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                      ...
                      <div className="flex items-center gap-2 h-9">
                        <h3 className="text-xl font-bold text-gray-900 leading-none">{activeCategory.name}</h3>
                        <button 
                          onClick={() => {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`h-9 px-4 rounded-xl font-bold text-[11px] uppercase tracking-wider transition-all cursor-pointer border shrink-0 flex items-center justify-center ${
                    ...
                    {showDeleteConfirm ? (
                      <div className="h-9 flex items-center gap-2 bg-red-50 border border-red-200 px-3 rounded-xl animate-in fade-in duration-100 shrink-0">
                        ...
                        <button
                          ...
                          className="h-6 px-2.5 flex items-center justify-center bg-red-600 hover:bg-red-700 text-white text-[10px] font-bold rounded-lg cursor-pointer transition-colors"
                        >
                          Yes
                        </button>
                        <button
                          ...
                          className="h-6 px-2.5 flex items-center justify-center bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 text-[10px] font-bold rounded-lg cursor-pointer transition-colors"
                        >
                          No
                        </button>
                      </div>
                ...
                <div className="bg-gray-50/50 border border-gray-150 rounded-2xl p-4 space-y-4">
                  <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Option information</span>
                  <div className="grid grid-cols-2 gap-6">
                    {/* Multi choice & Services toggle */}
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-700">Multi choice selection</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-700">Free selection of services</span>
                        <button
                    ...
                    {activeCategory.isFreeSelection && (
                      <div className="flex flex-col justify-end">
                        <span className="text-xs font-bold text-gray-500 mb-1.5">Number of selections for free</span>
                        {editingField === 'free_count' ? (
                          <div className="flex gap-2 items-center">
                            <input
                              ...
                              onChange={(e) => setTempInputValue(e.target.value)}
                              className="bg-white border border-gray-300 focus:border-corgi focus:ring-2 focus:ring-corgi/20 rounded-xl px-3 py-1.5 text-xs font-bold text-gray-950 outline-none w-20 transition-all"
                              autoFocus
                            />
                            <button 
                              onClick={() => {
                          ...
                          <div className="flex items-center gap-1.5">
                            <span className="text-sm font-bold text-gray-900">{activeCategory.freeSelectionsCount}</span>
                            <button 
                              onClick={() => {
                ...
                <div className="bg-white border border-gray-150 rounded-2xl overflow-hidden">
                  <div className="px-4 py-3 border-b border-gray-100 bg-gray-50/50">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Selections</span>
                  </div>
                  <table className="w-full text-left text-xs">
                    <thead>
                      <tr className="border-b border-gray-100 text-gray-400 font-bold bg-gray-50/20">
                  ...
                  <div className="p-3 bg-gray-50/30 border-t border-gray-100">
                    <button
                      ...
                      className="text-xs font-bold text-corgi hover:text-orange-600 flex items-center gap-1 cursor-pointer transition-colors"
                    >
                ...
                <div className="space-y-3" data-testid="modifier-category-links">
                  <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Menu categories linked to this group</span>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-3 flex-1 flex flex-col justify-between pointer-events-none">
                            <span className="text-xs font-bold text-gray-900 truncate w-full" title={dish.name}>
                              {dish.name}
                            </span>
                            <span className="text-[11px] font-bold text-corgi mt-1.5 block">
            ...
            <div className="p-5 flex-1 space-y-5">
              ...
              {selStep === 1 ? (
                ...
                <div className="space-y-4">
                  {/* Price Field */}
                  <div className="space-y-1.5">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Price (€)</span>
                    <div className="relative">
                      <input
                        ...
                        className="h-10 w-full bg-white border border-gray-200 focus:border-corgi focus:ring-4 focus:ring-corgi/10 rounded-xl px-4 pr-12 text-sm font-bold text-gray-900 outline-none transition-all"
                        placeholder="0,00"
                      />
                      <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-bold text-gray-400">EUR</span>
                    </div>
                  </div>

                  {/* Language Selector */}
                  <div className="space-y-1.5">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Language selection</span>
                    <div className="relative">
                      <select
                        value={selSourceLang}
                        onChange={(e) => setSelSourceLang(e.target.value)}
                        className="h-10 w-full bg-white border border-gray-200 focus:border-corgi focus:ring-4 focus:ring-corgi/10 rounded-xl px-4 pr-10 text-sm font-bold text-gray-900 outline-none transition-all appearance-none cursor-pointer"
                      >
                  ...
                  {/* Name field */}
                  <div className="space-y-1.5">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Selection name</span>
                    <textarea
                      value={selName}
                      onChange={(e) => {
                      ...
                      className="w-full bg-white border border-gray-200 focus:border-corgi focus:ring-4 focus:ring-corgi/10 rounded-xl p-3.5 text-sm font-bold text-gray-900 outline-none transition-all resize-none h-20"
                ...
                /* Step 2: Translations */
                <div className="space-y-4">
                  <div className="flex border-b border-gray-100 pb-2 gap-4 text-xs font-bold text-gray-400">
                     ...
                     {Object.keys(selTranslations).map((lang) => {
                       ...
                       return (
                         <div key={lang} className="flex gap-4 items-center">
                           <span className="w-20 text-xs font-bold text-gray-500 text-center uppercase tracking-wider bg-gray-50 py-1.5 rounded-lg border border-gray-150 shrink-0">
                             {langNames[lang] || lang}
                           </span>
                           <input
                             type="text"
                             ...
                             className="h-10 flex-1 bg-white border border-gray-200 focus:border-corgi focus:ring-4 focus:ring-corgi/10 rounded-xl px-4 text-xs font-bold text-gray-900 outline-none transition-all"
              ...
              {selStep === 1 ? (
                <>
                  ...
                  <button
                    ...
                    className={`px-5 py-2.5 text-xs font-bold rounded-xl text-white cursor-pointer transition-all active:scale-[0.98] ${
                ...
                <>
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-corgi hover:bg-corgi/90 text-xs font-bold rounded-xl text-white cursor-pointer transition-all active:scale-[0.98]"
                  >
                    Save
                  </button>
                </>
