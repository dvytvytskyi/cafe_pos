              ...
              {selectedSticker.unlocked && (
                <div className="flex flex-col gap-2.5 w-full mb-4">
                  ...
                  <div className="flex gap-3 w-full">
                    ...
                    <button
                      onClick={() => {
                        const stickerUrl = getPublicStickerUrl(selectedSticker.path);
                        const text = `I unlocked the "${selectedSticker.name}" sticker at Corgi Cafe! 🐶☕️`;
                        const shareUrl = `https://t.me/share/url?url=${encodeURIComponent(stickerUrl)}&text=${encodeURIComponent(text)}`;
                      ...
                      title="Share Corgi Sticker on Telegram"
                    >
                    ...
                    <button
                      onClick={() => {
                        const stickerUrl = getPublicStickerUrl(selectedSticker.path);
                        const text = `I unlocked the "${selectedSticker.name}" sticker at Corgi Cafe! 🐶☕️ ${stickerUrl}`;
                      ...
                      title="Share Corgi Sticker on WhatsApp"
                    >
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
