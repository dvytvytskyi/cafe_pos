...
export default function LoyaltyPage() {
  ...
  if (isLoggedIn && loyalty) {
    ...
    return (
      <div className="h-screen overflow-y-auto bg-white pb-[90px] relative scroll-smooth">
        {/* Profile Header */}
        <div className="bg-gradient-to-b from-[#FDBD38] to-[#FDB01A] text-gray-900 px-6 pt-6 pb-20 rounded-b-[36px] relative">
          <div className="max-w-[440px] mx-auto flex items-center justify-between">
  ...
  return (
    <div className="h-screen w-full overflow-y-auto bg-white flex flex-col items-center pb-32">
      ...
      <div className="w-full bg-gradient-to-b from-[#FDBD38] to-[#FDB01A] text-white pt-10 pb-28 px-6 relative overflow-hidden select-none">
